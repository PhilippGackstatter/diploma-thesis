...
% Perhaps what this test also or *really* tests, is: Given an action that takes the exact same amount of time to execute on different executors, what are the overheads? If one takes longer than the other, then that executor must introduce a higher latency.
