...
\citeauthor{Lehmann2020} provide a critique of WebAssembly's binary security. Many mitigations that have made \inl{x86} binaries safer are not present in WebAssembly. According to them, this »re-enables several formerly defeated attacks«. Some of the important points include:
