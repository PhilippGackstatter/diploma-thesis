...
\begin{quote}
    \quot{[...] inherently different nature of Edge infrastructure, for example, in terms of available resources network, geographical hyper-distribution, very large scale, etc.}
\end{quote}
