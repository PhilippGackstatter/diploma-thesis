...
% Managed services or Backend-as-a-Service (BaaS) are frequently used together with serverless, due to serverless functions being stateless. An example is AWS AppSync\footnote{\url{https://aws.amazon.com/appsync/}}, a managed GraphQL API, where AWS Lambdas can resolve fields of a GraphQL type, for example, by querying multiple databases at once.
