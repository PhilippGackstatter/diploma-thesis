...
In the rest of this section we explore the available options and discuss them in the context of these requirements.
...
To implement these requirements in Apache OpenWhisk we take the following steps. The current Docker-based \inl{Invoker} will be replaced, to forward all the incoming requests to our new Wasm executor.
